...
<head>
    ...
    <meta name="Keywords" content="常州大学宾馆管理系统">
    <meta name="Description" content="常州大学宾馆管理系统">
...
<header>
    <div>
        <a href="index.html"><img src="/static/home/images/logo-1.jpg" alt=""></a> <span>会员登录</span>
    </div>

</header>
<section>
    <div class="left">
        <img src="/static/home/images/index.jpg" alt="">
    </div>
    <div class="login">
        ...
        <div id="normal">
            ...
            <div class="codes" style="margin-top:25px;">
                ...
                <img id="cpacha-img" src="/admin/get_cpacha?vl=4&w=173&h=33&type=accountLoginCpacha"
...
<script>
    function changeVcode() {
        $("#cpacha-img").attr("src", '/admin/get_cpacha?vl=4&w=173&h=33&type=accountLoginCpacha&t=' + new Date().getTime());
    }
