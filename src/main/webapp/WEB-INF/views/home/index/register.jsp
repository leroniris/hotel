...
<head>
    ...
    <link href="/static/home/css/regsiter.css" type="text/css" rel="Stylesheet"/>
...
<header>
    <div>
        <a href=""><img src="/static/home/images/logo-1.jpg" alt=""> </a> <span>注册</span>
    </div>
...
<div id="reg">
    ...
    <div class="msg">
        <div class="panel">
            <form id="user_info">
                <div class="form-group">
                    ...
                    <input required minlength="3" maxlength="9" type="text" placeholder="请输入用户名" autofocus name="name"
                           id="uname"/>
        ...
        <div id="ad">
            ...
            <ul id="trigger">
                <li><img src="/static/home/images/new1.png" alt=""></li>
            </ul>
